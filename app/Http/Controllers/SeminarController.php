...
class SeminarController extends Controller
{
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'harga_per_orang' => 'required|integer',
            'harga_dua_orang' => 'required|integer',
            'harga_di_tempat' => 'required|integer',
        ]);
        ...
        Seminar::create([
            ...
            'harga_dua_orang' => $request->harga_dua_orang,
            'harga_di_tempat' => $request->harga_di_tempat,
        ]);

        return redirect()->back()->with('success', 'Data Seminar berhasil disimpan');
    }
}
