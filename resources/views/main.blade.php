                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="p-4 border rounded-3 shadow-sm h-100">
                            ...
                            <p class="text-muted">
                                Kami menyederhanakan dunia properti lewat konsep before–after dengan strategi nyata yang langsung bisa dipakai.
                            </p>
        ...
        <section class="bg-books">
            ...
            <div class="container-fluid py-5">
                ...
                <p class="mb-4 text-center fw-medium text-muted p-4">
                    Kami menyederhanakan dunia properti lewat konsep before–after dengan strategi nyata yang langsung bisa dipakai. Tanpa teori bertele-tele — hanya langkah praktis menuju kebebasan finansial lewat properti.
                </p>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <p class="card-text flex-grow-1">Ringkasan/Deskripsi singkat buku 1 …</p>
